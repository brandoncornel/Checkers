package System;/*
 * System.NetworkPlayer.java
 *
 * Version:
 *   $Id: System.NetworkPlayer.java,v 1.1 2002/10/22 21:12:53 se362 Exp $
 *
 * Revisions:
 *   $Log: System.NetworkPlayer.java,v $
...
public class NetworkPlayer extends Player {
    ...
    * send the move along to Model.Rules, or call processCommand.
    *
   ...
   public void waitForPlayer()
   {
       ...
       do {
            ...
            if ( inputObj instanceof Integer ) {
                ...
                // this may conflict with System.Driver class
		...
		// DEBUG:
                System.out.println( "Model.Move received." );
                outputObj = new Integer( ROGER );
                try {
                        out.writeObject( outputObj );
                } catch ( IOException e ) {
