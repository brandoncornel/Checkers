 ...
 *
 * Version
 *    $Id: System.Driver.java,v 1.1 2002/10/22 21:12:52 se362 Exp $
 *
 * Revisions:
 *    $Log: System.Driver.java,v $
...
public class Driver {
	...
	if ( activePlayer == player ){
		...
		JOptionPane.showMessageDialog( null,
	       	       activePlayer.getName() + " made an illegal move",
      	       	       "Invalid Model.Move", JOptionPane.INFORMATION_MESSAGE );
	    } else {
		JOptionPane.showMessageDialog( null,
	...
	if ( gameType == theFacade.HOSTGAME ) {
	    ...
	    //( (System.NetworkPlayer)playerTwo).waitForConnect();
	} else if ( gameType == theFacade.CLIENTGAME ) {
	    //( (System.NetworkPlayer)playerOne).connectToHost();
