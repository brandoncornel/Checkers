 ...
 *
 * Version:
 *    $Id: Model.Player.java,v 1.1 2002/10/22 21:12:53 se362 Exp $
 *
 * Revisions:
 *    $Log: Model.Player.java,v $
...
public abstract class Player {
    ...
    /**
     * Create a new instance of a Model.Player object to represent
     * one of the users.
     * 
     * @param num       The number of the player.
     * @param newRules  The rules used to validate moves.
     * @param newDriver System.Driver which will control this.
     */
    ...
    /**
     * Make an istance of a Model.Move that was just made and pass it
    ...
    public String toString(){
        return ("Model.Player.  name = " + playerName);
    }
